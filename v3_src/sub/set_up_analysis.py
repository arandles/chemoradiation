...
def main(
    ...
    out_file="summary_fractional_change.csv",
):
    base = Path(base_dir)
    ...
    # Collect all normalized values by timestep
    vals_by_t = {}
    for s in all_series:
        for t, v in s.items():
    ...
    with out_path.open("w", newline="") as f:
        ...
        writer.writerow([
            "timestep",
            "mean_fractional_change",
            "median_fractional_change",
            "p25_fractional_change",
            "p75_fractional_change",
            "iqr_fractional_change",
            "n_files"
        ])
